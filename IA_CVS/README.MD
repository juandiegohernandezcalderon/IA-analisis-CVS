...
1.  Extraer información clave de los CVs (habilidades, experiencia, etc.).
2.  Generar embeddings (representaciones numéricas) tanto para CVs como para proyectos.
3.  Calcular la "sensibilidad" o "acople" entre CVs y proyectos utilizando la similitud del coseno de sus embeddings.
...
1.  **Clona este repositorio** (si lo estuvieras versionando con Git) o navega a la carpeta del proyecto.
